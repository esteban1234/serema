  ...
  <head>
   ...
   <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0"> 
    ...
    <META name="Description" content="Somos una compañía dedicados a ofrecer servicios de comercialización de refacciones de automoviles."/>
     <META NAME="Keywords" CONTENT="Comercialización de refacciones de automoviles."/>
    ...
    <div class="fondo">
      <div class="menu">
        ...
        <figure class="logo pull-left">
          <img src="img/serema.png" alt="SEREMA" class="img-responsive">
        </figure>
      ...
      <p class="subtit-cc">Tenemos todas las partes de mayor venta</p>
...
<section class="seccion1" id="NOSOTROS" >
  <div class="leyenda">
    <p>Años respaldan nuestra trayectoria como líderes en el segmento de repuestos para el automotor.</p>
  </div>
  ...
  <div class="section" style="padding: 5% 0%;">
    ...
    <div class="section" style="padding: 5% 0% 5% 0%; background: #4E8831;" >
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-3">
            ...
            <p class="txt-saeo">
              ...
              <i class="fas fa-angle-double-right"></i> Bombas de Agua <br>
              <i class="fas fa-angle-double-right"></i> Termostato <br>
              <i class="fas fa-angle-double-right"></i> Bulbos Automotrice <br>
              <i class="fas fa-angle-double-right"></i> Tapone <br>
              <i class="fas fa-angle-double-right"></i> Poleas Térmica <br>
              <i class="fas fa-angle-double-right"></i> Enfriadores de Aceit <br>
              <i class="fas fa-angle-double-right"></i> Manguera <br>
              <i class="fas fa-angle-double-right"></i> Abrazaderas
          ...
          <div class="col-sm-6 col-md-3">
            ...
            <p class="txt-saeo">
              ...
              <i class="fas fa-angle-double-right"></i> Compresores<br>
              <i class="fas fa-angle-double-right"></i> Evaporadores<br>
              <i class="fas fa-angle-double-right"></i> Filtros Deshidratadores<br>
              <i class="fas fa-angle-double-right"></i> Filtros Para Autos<br>
              <i class="fas fa-angle-double-right"></i> Válvulas de Expansión<br>
              <i class="fas fa-angle-double-right"></i> Sensores<br>
              <i class="fas fa-angle-double-right"></i> Cámaras Plenas<br>
              <i class="fas fa-angle-double-right"></i> Carga de Gas Refrigerante
          ...
          <div class="col-sm-6 col-md-3">
            ...
            <p class="txt-saeo">
               ...
               <i class="fas fa-angle-double-right"></i> Alternadores<br>
               <i class="fas fa-angle-double-right"></i> Generadores<br>
               <i class="fas fa-angle-double-right"></i> Motoventiladores<br>
               <i class="fas fa-angle-double-right"></i> Distribuidores<br>
               <i class="fas fa-angle-double-right"></i> Faros<br>
               <i class="fas fa-angle-double-right"></i> Focos<br>
               <i class="fas fa-angle-double-right"></i> Calaveras<br>
               <i class="fas fa-angle-double-right"></i> Bujías<br>
               <i class="fas fa-angle-double-right"></i> Bobina de Encendido<br>
               <i class="fas fa-angle-double-right"></i> Plumas Limpiaparabrisas
          ...
          <div class="col-sm-6 col-md-3">
            ...
            <p class="txt-saeo">
              ...
              <i class="fas fa-angle-double-right"></i> Químicos
  ...
  <div class="row cont-portion">
      ...
      <div class="box">             
        <div class="icon">
          ...
          <div class="info">
            <h3 class="title">CORREO & WEBSITE</h3>
            <p>
              <i class="fa fa-envelope" aria-hidden="true"></i> &nbsp info@seremaservicios.com
              <br>
              <br>
        ...
        <div class="icon">
          ...
          <div class="info">
            <h3 class="title">DIRECCION</h3>
              <p>
               <i class="fa fa-map-marker" aria-hidden="true"></i> &nbsp Av. 62-A #609-E POR 83 Y 85 COL. LA HERRADURA II, CAUCEL, YUCATAN. C.P. 97314.
            </p>
          </div>
        </div>
        <div class="space"></div>
        ...
        <div class="icon">
          ...
          <div class="info">
            <h3 class="title">HORARIO</h3>
              <p>
               <i class="fa fa-clock" aria-hidden="true"></i> &nbsp Lunes a Viernes de 9 am a 6 pm
            </p>
          </div>
        </div>
        <div class="space"></div>
...
<footer>
<p>Derechos de autor 2018 © |  SERVICIOS Y REFACCIONES DEL MAYAB SA DE CV</p>
</footer>
